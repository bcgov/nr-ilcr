 ...
 * upsert ran, the verbatim success message (AD-8), and the reloaded table so the grid refreshes in
 * a single round-trip (legacy reloaded the grid after every save).
 *
