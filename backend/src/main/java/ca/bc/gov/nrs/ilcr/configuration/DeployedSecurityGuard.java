 ...
 * {@code MockPrincipalFilter}, so every anonymous request acts as an authenticated
 * {@code ILCR_SUBMITTER} — acceptable for local development, an authentication bypass when the pod
 * is reachable through a public route and connected to a real database.
 *
