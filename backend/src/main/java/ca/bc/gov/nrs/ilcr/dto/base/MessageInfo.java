...
/**
 * A user-facing message carried on a mutating/confirming response (AD-8/EQ-M3): the LEGACY
 ...
 * {@code dto.base} package so no feature module (schedule1..11, millcontext) has to reach into another
 * for it. Structurally identical across every consumer, so the pinned wire contract stays uniform
 * (AD-12).
 *
