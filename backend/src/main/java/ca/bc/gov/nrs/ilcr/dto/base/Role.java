 ...
 *
 * <p>Roles are used for authorization checks (for example in Spring Security expressions such
 * as @PreAuthorize) and are typed as ABSTRACT or CONCRETE via the {@link RoleType} enum. The {@link
 * #fromValue(String)} factory supports case-insensitive deserialization from strings.
 */
@Getter
