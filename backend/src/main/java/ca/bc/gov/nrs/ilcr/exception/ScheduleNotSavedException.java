...
/**
 * Raised when a schedule save/delete fails at the persistence layer (a repository
 * {@code DataAccessException}). Maps to 500 with the verbatim legacy {@code scheduleNotSavedErrorMsg}
 * ("Schedule could not be saved."). The {@code @Transactional} write boundary rolls back before this
 * surfaces, so a retried request can succeed.
 *
