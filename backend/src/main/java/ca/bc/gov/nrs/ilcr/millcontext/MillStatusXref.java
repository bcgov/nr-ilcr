 ...
 * Exists only to give {@link MillContextRepository} a mapped root; all mill/year context access
 * goes through explicit {@code @Query} methods, and the service maps results to decisions (entities
 * never cross the service boundary — AD-3). Never persisted via the CRUD API.
 */
