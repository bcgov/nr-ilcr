 ...
 * reporting year is not opened (Story 1.2 AC6). Maps to HTTP 404 with bundle key {@code
 * millYearContextNotFoundErrorMsg} — a recorded deviation: no legacy text exists because the
