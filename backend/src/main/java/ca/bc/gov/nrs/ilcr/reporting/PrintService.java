 ...
 * order (3 → 5 → 6 → 7A → 7B → 9 → 10 → 11, the {@link ScheduleKey} declaration order), SKIPS any
 ...
 * ERR-005).
 *
 * <p>Selected-but-unimplemented schedules (1/2/8) and the mill-information-report option are
    ...
    if (anyUnimplemented) {
      ...
      log.debug(
          "Print selection includes schedules/options not yet implemented in Epic 20 "
              + "(1/2/4/8 and/or the Mill Information report); those are skipped for now");
    }
  }
}
