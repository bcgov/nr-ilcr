...
/**
 * Internal outcome of {@code ReportingYearService.open} — the year created and how many active mills
 * were initialized. The controller resolves the verbatim success message (AD-8) and maps this to the
 * client-facing {@link OpenReportingYearResponse}.
 *
