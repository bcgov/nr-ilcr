 ...
 * {@code roadName}, {@code materialTypeTotal}, …); {@code message} carries the resolved legacy text.
 * The service emits the key with null text and the controller composes the final string, so the
