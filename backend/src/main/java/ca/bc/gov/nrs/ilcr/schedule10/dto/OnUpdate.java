 ...
 * create (POST). Its members are the {@code revisionCount} tokens on {@link ConstructionPageRequest}
 * and {@link RoadDetailRequest} — required on an edit (optimistic lock) but meaningless on a create.
 *
 ...
 * cross-schedule extraction of these markers is tracked as separate consolidation work, and reaching
 * across domain packages for it would couple two schedules that are otherwise independent.
 */
