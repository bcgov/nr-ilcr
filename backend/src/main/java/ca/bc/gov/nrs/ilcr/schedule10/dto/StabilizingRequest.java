 ...
 * material code to {@code "NA"}, while {@code C} — and, in legacy, a blank code — coerces both
 * costs to zero. The service reproduces that coupling, including legacy's asymmetry where {@code N}
 * writes zeros into the four dimensions and {@code D} leaves them null.
 *
