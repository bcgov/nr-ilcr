...
/**
 * Spring Data JDBC row shape for one Schedule 11 cost detail (AD-3): a {@code
 * THE.ILCR_COST_REPORT_DETAIL} row belonging to a silviculture location (24 = Actual, 23 = Planned
 * — legacy {@code REPORT_COST_ITEMS.Schedule11_1_*}). {@code VOLUME} and {@code ITEM_DESCRIPTION}
 * are unused by Schedule 11 and not read. Never crosses the service boundary — {@code
 * Schedule11Service} unpacks these into the per-location cost fields.
 *
