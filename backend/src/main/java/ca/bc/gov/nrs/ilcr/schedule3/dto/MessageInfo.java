 ...
 * resolved verbatim text. The frontend renders {@code text} and never hardcodes the SUC/WRN
 * strings.
 *
 * <p>Schedule 3 keeps its own copy of this generic envelope rather than importing Schedule 1's
 * {@code schedule1.dto.MessageInfo} — the schedule domains are peers and neither depends on the
 * other (a later refactor may promote it to a shared {@code dto.base} package).
 *
