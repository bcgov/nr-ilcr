...
/**
 * The Other Acceptable Costs sub-resource document (AD-5/AD-12) — the itemized item-124 groups plus
 * the server-computed three-column subtotal. Returned by GET and echoed (with a {@code message}) by
