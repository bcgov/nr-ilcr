 ...
 * {@code total} and {@code pop} are OPTIONAL costs in the default range (legacy permits blank at
 * Save — Check Status catches missing). Crown is derived server-side and never client-supplied.
 * Range messages resolve the LEGACY bundle keys (AD-8) via the wired {@code MessageSource}.
 *
