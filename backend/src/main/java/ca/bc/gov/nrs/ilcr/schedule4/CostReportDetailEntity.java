 ...
 * used by Schedule 4 (AD-3): each row hangs off a {@code TRANSPORTATION_REPORT} via {@code
 * TRANSPORTATION_REPORT_ID} (not a summary), carries one category/sub-page code, and — for sub-page
 * rows — a free-text {@code ITEM_DESCRIPTION}.
 */
