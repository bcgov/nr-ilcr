 ...
 * ILCRDistanceValidator.java:16-17}) — while {@code distanceValidatorErrorMsg} says "999,999",
 * understating the bound by 0.9 (deviation (H), an Open Question for the Ministry, and real
