...
/**
 * Save-all request for the page-level Save (legacy {@code Schedule7aMB.save()} →
 * {@code saveSchedule7a(schedule7a)}, which persisted EVERY bridge report of the schedule in one
 ...
 *
 * @param bridges the bridges to save (at least one; an empty schedule has nothing to save, which the
 *     legacy {@code anyDataToSaveInfoMsg} branch reported rather than persisting)
 */
