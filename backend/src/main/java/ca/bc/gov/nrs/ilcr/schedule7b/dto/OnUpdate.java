 ...
 * an edit is a clean 400 — never a coerced-{@code -1} 409, which would report a phantom concurrent
 * edit for what is simply a malformed request (the established schedule idiom).
 */
