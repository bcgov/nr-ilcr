...
/**
 * The Schedule 8 (Tree to Truck / Special Skidding Costs) read document (AD-5, AD-12) — the pinned
 * GET response, frozen for all Schedule 8 stories. Unlike Schedules 1–3 (flat aggregates on {@code
 * ILCR_REPORT_SUMMARY}), Schedule 8 is a three-level hierarchy: each {@link Page} is a {@code
 * TREE_TO_TRUCK_REPORT} row carrying its {@code samples}, and each {@link Sample} carries its
