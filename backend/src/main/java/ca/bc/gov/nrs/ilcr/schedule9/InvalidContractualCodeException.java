 ...
 * enforcement, FLD-005/S26; the legacy FK would have rejected it). A blank code is instead a
 * missing required field (FLD-001), reported separately; this is the present-but-not-in-the-list
 * case.
 *
 * <p>Maps to 400 with the verbatim {@code invalidCodeValueErrorMsg} ({@code "A valid value must be
