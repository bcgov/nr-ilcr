package ca.bc.gov.nrs.ilcr.service.codes;

import ca.bc.gov.nrs.ilcr.configuration.IlcrConfiguration;
import ca.bc.gov.nrs.ilcr.dto.base.CodeDescriptionDto;
import ca.bc.gov.nrs.ilcr.mappers.codes.DistrictMapper;
import ca.bc.gov.nrs.ilcr.repository.codes.OrgUnitRepository;
 ...
 *
 * <p>Loads configured districts from {@link IlcrConfiguration} and maps database projections
...
public class DistrictService {
  ...
  private final IlcrConfiguration configuration;
