...
/**
 * Acceptance test for authorization on VIEW_SCHEDULE (AD-7) for Schedule 2. Security ON; drives the
 * real {@code oauth2ResourceServer} chain + {@code @PreAuthorize}. Authorities derive through the
 * production {@link CognitoGroupsJwtAuthenticationConverter}, mirroring the Schedule 1 pattern.
 */
@TestPropertySource(properties = "ilcr.security.enabled=true")
@DisplayName("GET /api/v1/schedule2 — authorization on VIEW_SCHEDULE (AD-7)")
class Schedule2AuthorizationIT extends AbstractOracleIT {
