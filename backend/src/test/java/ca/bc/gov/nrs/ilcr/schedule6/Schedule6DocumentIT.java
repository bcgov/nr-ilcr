...
class Schedule6DocumentIT extends AbstractOracleIT {
  ...
  void draftContext_listsRecordsWithDerivedFigures() throws Exception {
    mockMvc.perform(get(ENDPOINT)
        ...
        // Record 8301 — TSA "01" + Supply Block "01B" -> RMG "15"; vol 1000 / cost 50000 -> $/m3 50.00.
  ...
  @Test
  @DisplayName("660/2021 lone comment (S18) — roadRecords [], zero totals, generalComments populated")
  void loneComment_returnsEmptyListWithGeneralComment() throws Exception {
    mockMvc.perform(get(ENDPOINT)
        ...
        .andExpect(jsonPath("$.generalComments", is("Only a general comment, no road records yet.")))
