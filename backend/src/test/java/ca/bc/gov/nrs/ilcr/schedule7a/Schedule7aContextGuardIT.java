...
/**
 * Story 12.1 acceptance — mill/year context guards for {@code GET /api/v1/schedule7a}
 * (AC6, slices S16/S17/S20; AD-4, AD-8). All errors are RFC 7807 {@code application/problem+json}
 * with VERBATIM legacy text (ERR-001's trailing space included). An empty bridge list for an active
 * Draft mill/year is a valid 200 (the list-schedule divergence). Security is OFF (mock
 * {@code ILCR_SUBMITTER}).
 */
