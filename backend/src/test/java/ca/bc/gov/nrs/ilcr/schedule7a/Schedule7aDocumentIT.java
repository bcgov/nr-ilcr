...
/**
 * Story 12.1 acceptance — {@code GET /api/v1/schedule7a} 200 aggregate document (AC1-AC5/AC7, slices
 * S01/S18; AD-5, AD-10, AD-12). Asserts the pinned wire contract via jsonPath against the V27 seed's
 * hand-computed values. Security is OFF (mock {@code ILCR_SUBMITTER}); authz is proven in
 * {@link Schedule7aAuthorizationIT}, guards in {@link Schedule7aContextGuardIT}.
 */
