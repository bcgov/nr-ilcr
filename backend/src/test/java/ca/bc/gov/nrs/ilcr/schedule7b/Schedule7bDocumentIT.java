 ...
 * values. Security is OFF (mock {@code ILCR_SUBMITTER}); authz is proven in {@link
 * Schedule7bAuthorizationIT}, guards in {@link Schedule7bContextGuardIT}.
 */
...
class Schedule7bDocumentIT extends AbstractOracleIT {
  ...
  void draftContext_returnsPinnedDocument() throws Exception {
    mockMvc
        ...
        // 7802 — complete Others: total 2500 + 700 = 3200; no span, which is fine for a non-Round
        // type.
        ...
        // 7803 — install cost row present but NULL: total is the material cost alone, never 900 +
        // 0.
  ...
  void codeList_excludesCodeEffectiveLaterInTheYear() throws Exception {
    ...
    // it first appears in RY2022. This is the fixture that makes effectiveOn() falsifiable: move
    // the
  ...
  void culvertsAreOrderedById() throws Exception {
    // The V20260811 seed inserts 514/2021's culverts as 7803, 7801, 7802 on purpose, so an
    // unordered
    // heap read would surface that sequence. The 1-based rowCounter that Check Status quotes back
    // to
  ...
  @Test
  @DisplayName(
      "A read is scoped to the requested REPORT_YEAR — mill 680 has 2020 and 2021 culverts")
