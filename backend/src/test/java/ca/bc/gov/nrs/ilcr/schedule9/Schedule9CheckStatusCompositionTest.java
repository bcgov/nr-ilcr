...
class Schedule9CheckStatusCompositionTest {
  ...
  private final Schedule9Controller controller = new Schedule9Controller(
  ...
  void valueRequiredSegments_composeVerbatim() {
    when(service.checkStatus(anyLong(), anyInt())).thenReturn(new Schedule9CheckStatusResponse(
        false,
        List.of(
            new MessageInfo("missingRequiredFieldMsg", "Contractual Work Report Id : 1 Company ID: Value Required"),
            new MessageInfo("missingRequiredFieldMsg", "Contractual Work Report Id : 1 Contractual Item: Value Required"),
            new MessageInfo("missingRequiredFieldMsg", "Contractual Work Report Id : 1 Side Slope %: Value Required"),
            new MessageInfo("missingRequiredFieldMsg", "Contractual Work Report Id : 1 Number of Units: Value Required"),
            new MessageInfo("missingRequiredFieldMsg", "Contractual Work Report Id : 1 Unit Type: Value Required"),
            new MessageInfo("missingRequiredFieldMsg", "Contractual Work Report Id : 1 Biogeoclimatic Zone: Value Required"),
            new MessageInfo("missingRequiredFieldMsg", "Contractual Work Report Id : 1 Cost$: Value Required"),
            new MessageInfo("missingRequiredFieldMsg", "Contractual Work Report Id : 1 Source: Value Required")),
        null));
  ...
  @Test
  @DisplayName("rangeError segments compose verbatim, using the real messages.properties invalidRangeErrorMsg")
  void rangeErrorSegments_composeVerbatim() {
    when(service.checkStatus(anyLong(), anyInt())).thenReturn(new Schedule9CheckStatusResponse(
        false,
        List.of(
            new MessageInfo("invalidRangeErrorMsg", "Contractual Work Report Id : 1 Side Slope %: Entered value must be between 0 and 99"),
            new MessageInfo("invalidRangeErrorMsg", "Contractual Work Report Id : 1 Number of Units: Entered value must be between 0.0 and 99,999.9"),
            new MessageInfo("invalidRangeErrorMsg", "Contractual Work Report Id : 1 Cost$: Entered value must be between 0 and 9,999,999")),
        null));
    ...
    assertEquals("Contractual Work Report Id : 1 Number of Units: Entered value must be between 0.0 and 99,999.9", body.errors().get(1).text());
    assertEquals("Contractual Work Report Id : 1 Cost$: Entered value must be between 0 and 9,999,999", body.errors().get(2).text());
  }
