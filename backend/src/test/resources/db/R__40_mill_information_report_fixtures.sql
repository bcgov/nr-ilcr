...
--
-- MILL_ID band 730-732. The README's range table stops at 716 but is stale: schedule 10 write took
...
-- four sections -- 514 plus the three below -- which keeps the multi-mill assertions deterministic.
--
