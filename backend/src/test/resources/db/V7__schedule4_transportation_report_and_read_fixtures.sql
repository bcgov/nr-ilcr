...
--     TR 7012 (DISTANCE 88.0):          52 Rail Haul, VOLUME present / COST NULL (perUnit null) —
...
-- 52 Rail Haul — its OWN report, DISTANCE 88.0 (different): VOLUME 300 / COST NULL (perUnit null)
INSERT INTO THE.TRANSPORTATION_REPORT (TRANSPORTATION_REPORT_ID, REPORT_YEAR, ILCR_MILL_ID, ILCR_CATEGORY_ID, LOCATION_DESCRIPTION, DISTANCE, TRANSPORTATION_CYCLE_TIME, ENTRY_USERID)
  VALUES (7012, 2021, 514, '4', 'Harbour Dump', 88.0, NULL, 'SEED');
