...
Suite state: **green except for the one intentional `@discovered-bug` red** tracking Bug/Regression #2.
...
- **clear-amounts** — the guarded fields it writes cannot be cleared back (Bug/Regression #2).
