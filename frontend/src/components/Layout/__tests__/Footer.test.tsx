...
describe('Footer', () => {
  test('shows the ILCR version on the left and the four BC Gov links (new tab)', () => {
    ...
    const expected: [string, string][] = [
      ['Copyright', 'http://www.gov.bc.ca/for/com/copyright.html'],
      ['Disclaimer', 'http://www.gov.bc.ca/for/com/disclaimer.html'],
      ['Privacy', 'https://dlvrapps.nrs.gov.bc.ca/com/privacy.html'],
      ['Accessibility', 'http://www.gov.bc.ca/for/com/accessibility.html'],
    ]
